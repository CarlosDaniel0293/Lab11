...
Route::get('/foto/eliminar',[App\Http\Controllers\FotoController::class, 'getEliminar']);
...
Route::post('/usuario/actualizar',[App\Http\Controllers\UsuarioController::class, 'postActualizar']);
